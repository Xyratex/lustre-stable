...
struct cfs_crypto_hash_type {
        char            *cht_name;      /**< hash algorithm name */
        char            *cht_fmt_name;  /**< format name for crypto api */
...
static struct cfs_crypto_hash_type hash_types[] = {
        [CFS_HASH_ALG_NULL]    = { "null",     "null",          0,      0 },
        [CFS_HASH_ALG_ADLER32] = { "adler32",  "adler32",       1,      4 },
        [CFS_HASH_ALG_CRC32]   = { "crc32",    "crc32",        ~0,      4 },
        [CFS_HASH_ALG_CRC32C]  = { "crc32c",   "crc32c",       ~0,      4 },
        [CFS_HASH_ALG_MD5]     = { "md5",      "md5",           0,     16 },
        [CFS_HASH_ALG_SHA1]    = { "sha1",     "sha1",          0,     20 },
        [CFS_HASH_ALG_SHA256]  = { "sha256",   "sha256",        0,     32 },
        [CFS_HASH_ALG_SHA384]  = { "sha384",   "sha384",        0,     48 },
        [CFS_HASH_ALG_SHA512]  = { "sha512",   "sha512",        0,     64 },
};
